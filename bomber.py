...
def selectnode(mode="sms"):
    ...
    try:
        ...
        max_limit = {"sms": 9999999999999999999999999999999999999999999999999, "call": 9999999999999999999999999999999999999999999999999, "mail": 9999999999999999999999999999999999999999999999999}
        cc, target = "", ""
        if mode in ["sms", "call"]:
            cc, target = get_phone_info()
            if cc != "91":
                max_limit.update({"sms": 9999999999999999999999999999999999999999999999999})
        elif mode == "mail":
