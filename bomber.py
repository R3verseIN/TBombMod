...
def bann_text():
   ...
   ▒▒▒██▒▒▒ ██▒▒██                ██
      ...
      MOD by sanketdon 
      Github - https://github.com/R3verseIN/TBombMod   
                                         """
    if ASCII_MODE:
        logo = ""
...
def selectnode(mode="sms"):
    ...
    try:
        ...
        max_limit = {"sms": 9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999, "call": 9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999, "mail": 999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999}
        cc, target = "", ""
        if mode in ["sms", "call"]:
